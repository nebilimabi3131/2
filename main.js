...
client.on("messageCreate", async message => {
    ...
    //let embed = new Discord.MessageEmbed().setColor("#00ffdd").setAuthor({text: message.author.tag, url:  message.author.avatarURL({ dynamic: true, })}).setFooter({text: `Mwss was here!`}).setTimestamp();
